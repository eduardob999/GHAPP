...
export const SKILL_CATALOG: readonly MicroSkillDefinition[] = [
  ...
  // first. Before these, the catalog taught fourteen chords and the progression
  // library used sixty-three: playing the app in order meant meeting A7, F and
  // D7 for the first time in a scored game.
  {
    id: 'fretting.open.e-major',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'beginner',
    title: 'Open E major',
    description: 'All six strings ring. The fullest-sounding chord on the guitar, and the shape every barre is built from.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'major',
  ...
  {
    id: 'fretting.open.f-major',
    category: 'fretting_shape',
    family: 'barre_chord',
    difficulty: 'intermediate',
    title: 'F major',
    description: 'The first barre. Index flat across the 1st fret, thumb behind the neck. Aim for the top four strings ringing before you chase all six.',
    suggestedDurationSeconds: 30,
    active: true,
    metadata: {
      chordQuality: 'major',
  ...
  },
  {
    ...
    difficulty: 'beginner',
    title: 'A7',
    description: 'Two fingers. The chord that makes a blues sound like a blues.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
  ...
  },
  {
    ...
    difficulty: 'beginner',
    title: 'D7',
    description: 'A small triangle on the top three strings. Keep the 1st string ringing.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'dominant7',
  ...
  },
  {
    ...
    difficulty: 'beginner',
    title: 'E7',
    description: 'Open E with the 4th string let go. Two fingers, six strings.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'dominant7',
  ...
  },
  {
    ...
    difficulty: 'beginner',
    title: 'G7',
    description: 'Open G with the 1st string moved down to the 1st fret. It wants to fall to C.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'dominant7',
  ...
  },
  {
    ...
    difficulty: 'intermediate',
    title: 'B7',
    description: 'Four fingers, and worth it — the turnaround chord in every blues in E.',
    suggestedDurationSeconds: 30,
    active: true,
    metadata: {
      chordQuality: 'dominant7',
  ...
  {
    id: 'fretting.open.a-minor7',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'beginner',
    title: 'Am7',
    description: 'Am with the 3rd string let go. One finger less, and a softer chord for it.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'minor7',
  ...
  {
    id: 'fretting.open.d-minor7',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'intermediate',
    title: 'Dm7',
    description: 'A small barre with the first finger across the top two strings.',
  ...
  {
    id: 'fretting.open.e-minor7',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'beginner',
    title: 'Em7',
    description: 'Em with the 2nd string at the 3rd fret. Two fingers, all six strings.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'minor7',
  ...
  {
    id: 'fretting.open.c-major7',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'beginner',
    title: 'Cmaj7',
    description: 'Open C with the 2nd string let go. Two fingers, and it sounds like a film ending.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'major7',
  ...
  {
    id: 'fretting.open.g-major7',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'beginner',
    title: 'Gmaj7',
    description: 'Open G with the 1st string at the 2nd fret. Bright and unresolved.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'major7',
  ...
  {
    id: 'fretting.open.f-major7',
    category: 'fretting_shape',
    family: 'open_chord',
    difficulty: 'beginner',
    title: 'Fmaj7',
    description: 'The four-string F. No barre — learn this one while the full F is still coming.',
    suggestedDurationSeconds: 20,
    active: true,
    metadata: {
      chordQuality: 'major7',
