  ...
  return (
    <main className="screen screen--centred">
      <section className="signin card">
        ...
        <h1 className="signin__title">Guitar Practice Companion</h1>
        <p className="signin__tagline">
          Short, focused practice for both hands. Your progress follows your Google account across
          every device.
        </p>
        ...
        <p className="signin__footnote">
          Google is the only sign-in method. We store your name, email and practice progress, and
          nothing else.
        </p>
      </section>
    </main>
